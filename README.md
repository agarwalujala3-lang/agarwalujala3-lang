...
- AWS serverless systems using Lambda, S3, DynamoDB, API Gateway, CloudFront, SES, and Textract
...
| --- | --- | --- | --- |
| **ReceiptPulse** | Serverless receipt intelligence platform with upload flow, extraction, categorization, review routing, charts, and history management. | AWS Lambda, S3, DynamoDB, API Gateway, Textract, SES, CloudFront, JavaScript | [Live](https://d2ijsg7huf2h2p.cloudfront.net) · [Repo](https://github.com/agarwalujala3-lang/ReceiptPulse) |
...
- Built and deployed a live AWS product that processes receipts with Textract and turns them into organized spending data.
...
![S3](https://img.shields.io/badge/S3-111827?style=for-the-badge&logo=amazons3&logoColor=569A31)
![API Gateway](https://img.shields.io/badge/API_Gateway-111827?style=for-the-badge&logo=amazonapigateway&logoColor=FF4F8B)
